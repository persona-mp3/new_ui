...
import {pool, bcrypt, Response, Request } from './globals.js'
...
export async function AuthUser(req: Request, res: Response, userCred: UserCred) :Promise<void>{
    ...
    try { 
        ...
        const firstAuth:FirstAuth | undefined = response[0][0]
